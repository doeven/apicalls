                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="px-3 px-sm-5 pb-2">
                                        ...
                                        <a href="{{ $_ENV['CURRENT_SANCTUM_STATEFUL_DOMAINS'] }}/reset-password/{{$token}}?email={{$email}}" class="email-btn">RESET PASSWORD</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-3 px-sm-5 pt-4 pb-3 pb-sm-5">
                                        <p>If you did not make this request, please contact us or ignore this message.</p>
                                        <p class="email-note">This is an automatically generated email please do not reply to this email. If you face any issues, please contact us at {{ settings()->email }}.com</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
