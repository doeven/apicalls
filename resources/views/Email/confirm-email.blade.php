                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="px-3 px-sm-5 pb-2">
                                        <p>Welcome! {{ $fname }},</p><br>
                                        <p> You are receiving this email because you have registered on {{ settings()->title }}.</p>
                                        <p>Click the link below to active your {{ settings()->title }} account.</p>
                                        <p class="mb-4">This link will expire in 60 minutes and can only be used once.</p>
                                ...
                                <tr>
                                    <td class="px-3 px-sm-5 pt-4">
                                        ...
                                        <a href="{{$url}}" class="link-block">{{ $url }}
                                    </td>
                                </tr>
                                <tr>
